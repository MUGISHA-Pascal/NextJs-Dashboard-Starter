...
const roles = [
  { id: 1, name: "Administrator", description: "Full access to all features" },
  {
    id: 2,
    name: "Manager",
    description: "Access to most features, excluding sensitive operations",
  },
...
const permissions = [
  ...
  },
  {
    id: 3,
    name: "Edit Content",
    description: "Create and modify content on the platform",
  },
  {
    id: 4,
    name: "Access Reports",
    description: "View and download analytical reports",
  },
  {
    id: 5,
    name: "Manage Billing",
